...
import { FaCropSimple, FaCamera } from "react-icons/fa6";
...
export const BannerCropper: React.FC<BannerCropperProps> = ({
	...
	return (
		<div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-sm">
			<div className="bg-white rounded-2xl shadow-xl overflow-hidden w-full max-w-[900px] h-[500px] flex flex-col">
				<div className="p-4 border-b border-gray-200">
					<h2 className="text-xl font-semibold">Crop Banner</h2>
				</div>
				<div
					ref={containerRef}
					className="flex-grow p-4 overflow-hidden flex items-center justify-center"
				>
					{imageSrc ? (
						<ReactCrop
							crop={crop}
