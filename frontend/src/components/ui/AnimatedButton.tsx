	...
	return (
		<section className="mt-10 flex items-center justify-center">
			<Link to="/signup">
				<button
					type="button"
					className="relative inline-block p-px font-semibold leading-6 text-white no-underline bg-gray-800 shadow-2xl cursor-pointer group rounded-lg shadow-zinc-900"
				>
					...
					<div className="relative z-10 flex items-center px-6 py-3 space-x-2 rounded-xl bg-gray-800/50 ring-1 ring-white/10 ">
						Get Started
						<svg
