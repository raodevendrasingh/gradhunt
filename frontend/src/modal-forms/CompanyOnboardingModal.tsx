...
import { useCompanySlugCheck } from "@/hooks/useCompanySlugCheck";
		...
		if (companySlug && !isValidSlug(companySlug)) {
			return (
				<p className="text-red-500 text-xs">
					Url can only contain lowercase letters and digits and dashes (max 16
					characters)
				</p>
			);
		}
						...
						<div className="relative z-10 w-full">
							...
							<form id="basicDetailForm" onSubmit={handleSubmit(onSubmit)}>
								...
								<div className="flex items-center justify-center mt-4">
									<Button
										type="submit"
										disabled={!isValid || isCheckingSlug || !isFieldValid}
